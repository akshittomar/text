  ...
  return (
    <>
      ...
      <div>
        <h1
          style={{
            color: props.mode === "light" ? "rgb(43 54 60)" : "#d3e9f0",
            marginTop: 19,
          }}
        >
        ...
        <div className="mb-3">
          <textarea
            ...
            style={{
              backgroundColor:
                props.mode === "dark" ? "rgb(43 54 60)" : "#d3e9f0",
              color: props.mode === "light" ? "rgb(43 54 60)" : "#d3e9f0",
            }}
            value={Text}
            onChange={changing}
        ...
        <div>
          ...
          >
            YOUR TEXT HAVE {Text.length} CHARACTERS AND{" "}
        ...
        <div>
          <button
            ...
            className={`btn btn-outline-${
              props.mode === "light" ? "info" : "secondary"
            }`}
          >
